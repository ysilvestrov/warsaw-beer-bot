...
5. **Оновити користувацьку інструкцію встановлення.** Додай новий магазин до
   списку підтримуваних магазинів у `docs/extension-install-uk.md` і перевір
   швидкий старт / розділ використання, щоб вони не перелічували застарілий набір
   доменів.
