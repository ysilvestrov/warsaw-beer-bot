...
7. **Фільтр не-пива (обовʼязково).** Адаптер не має віддавати картками паки/сети/мерч/
   ...
   Навмисний виняток — Beershop: category-fixture може вправляти whole-page gate; якщо
   така фікстура містить змішану сітку, bespoke-тест МУСИТЬ перевірити і пиво, і не-пиво.
