...
`ensureOrphan`) реалізоване, пройшло наскрізне рев'ю й виправлення (коміти `61ebe93`, `4f307eb`,
`a0db1a9`). Цей план лише **перемикає** викликачів і прибирає стару функцію.
