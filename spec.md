...
семантика («найглибший курсор, з якого варто продовжувати»), що й раніше; `complete` застаріле
й завжди `false` (нічого не пише — див. §3.14); `profileTotal` тут завжди `null` (маршрут
