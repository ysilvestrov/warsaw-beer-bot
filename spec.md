...
- **Триаж-інбокс (#509).** Рядки, чию ціль відмовив scope-гейт вище, не зникають з
  ...
  загальна кількість рядків із класом і без issue за весь час, не лише за
  сьогодні. Issue з міткою `triage-inbox` **ніколи** не несе мітку `orphan-triage`:
  ...
  список, — це означає «ґрунт», а не «вирішено назавжди»: наступний запуск,
