...
інший **злінкований** рядок каталогу має той самий текст **і той самий ABV ключа**; сирота з тим самим текстом і
злінкований близнюк з іншим ABV його не вимикають.
...
storage-мутатори (`upsertBeerByBid`, `ensureOrphan`, `recordLookupSuccess`, `mergeIntoCanonical`, `deleteAlias`,
