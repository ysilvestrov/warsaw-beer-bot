...
(вхідна броварня покриває назву пива кандидата, а вхідна назва покриває зареєстровану броварню
кандидата через `swappedBrandNameScore`), кандидат оцінюється у `brandPool` і приймається за умови
відсутності суперечності ABV (`pickUniqueByAbv`).
