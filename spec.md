...
### 3.6.3 Неактивна стара сирота (#695; контракт, ще не впроваджено)
...
web fallback, щоденному тріажі та issue-close rearm. `/match` (і MCP) не дають
матчу для його **точного** ключа. `/enrich/candidates` відповідає `eligible: false`,
