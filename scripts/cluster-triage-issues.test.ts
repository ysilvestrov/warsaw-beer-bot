...
Also see beer \`#34252\` and \`34253\`.
  ...
  it('does not extract 2-3 digit issue references, backticked #issue numbers, vintage years, or short table cells as beer IDs', () => {
    const text = `
Regression introduced by \`#663\`, \`#1234\`, and \`123\`.
This beer 2020 vintage is still orphaned.
Also beer \`2020\` vintage, beer \`2020\` **vintage**, and beer **2020** vintage.
Catalog beer ID \`20804\` vintage mismatch, and beer ID 20805 vintage mismatch.
| count | status |
|---|---|
| 25 | live |
| vintage | status |
...
| 34250 | EvilTwin | Doughnut Break |
| **34251** | Stone | Arrogant Bastard |
Also mention bare catalog beer 20804, beer id 34221, beer \`#34252\`, row \`31170\`, and | **37334** |.
    `;
    const ids = extractBeerIds(text);
    ...
    expect(ids).toContain(34250);
    expect(ids).toContain(34251);
