...
// #636: рядок пари, яким може бути картка. Картка — вхід, рядок — кандидат: лише `same` > `year-fallback`, у межах
// рівня — найстаріший рядок (детермінізм замість порядку `.get()`, який віддавав картці «Rochefort 10» рядок
// «Rochefort 6»). `number-fallback` сюди не входить: у рядок пари цей ендпоінт ПИШЕ bid картки (і репарація #384 —
// bid крамниці), а рядок зберігає власний текст (#618) — вгадування «Juicy Trap — це #20» стало б ідентичністю
